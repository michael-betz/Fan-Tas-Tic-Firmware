...
const uint16_t g_ssi_lut[16] = {                        // Encodes a 4 bit nibble to a 16 bit SPI word
    0x8888, //0b1000100010001000,     //0               // The SPI modules sends MSB first!
    0x888C, //0b1000100010001100,     //1
    0x88C8, //0b1000100011001000,     //2
    0x88CC, //0b1000100011001100,     //3
    0x8C88, //0b1000110010001000,     //4
    0x8C8C, //0b1000110010001100,     //5
    0x8CC8, //0b1000110011001000,     //6
    0x8CCC, //0b1000110011001100,     //7
    0xC888, //0b1100100010001000,     //8
    0xC88C, //0b1100100010001100,     //9
    0xC8C8, //0b1100100011001000,     //A
    0xC8CC, //0b1100100011001100,     //B
    0xCC88, //0b1100110010001000,     //C
    0xCC8C, //0b1100110010001100,     //D
    0xCCC8, //0b1100110011001000,     //E
    0xCCCC  //0b1100110011001100,     //F
};
